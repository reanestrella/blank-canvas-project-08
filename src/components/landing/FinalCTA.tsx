  ...
  return (
    <section className="gradient-primary relative overflow-hidden py-20 text-sidebar-foreground md:py-28">
      <div className="absolute inset-0">
        <div className="absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/15 blur-[150px]" />
      </div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <Link to="/registro">
          <Button
            size="lg"
            className="gradient-accent rounded-xl px-10 py-6 text-base font-bold text-secondary-foreground shadow-[var(--shadow-glow)] transition-all hover:scale-[1.03] md:text-lg"
          >
