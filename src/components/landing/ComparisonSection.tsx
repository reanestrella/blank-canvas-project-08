    ...
    <section className="py-20 md:py-28 bg-[hsl(222,47%,11%)]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[hsl(40,33%,98%)]">
            Quanto custa ter um{" "}
        ...
        <div className="max-w-3xl mx-auto grid md:grid-cols-2 gap-6">
          ...
          <div className="p-8 rounded-2xl border-2 border-secondary bg-secondary/5 shadow-[0_0_40px_hsl(38,92%,50%,0.15)] relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-5 py-1 rounded-full gradient-accent text-[hsl(222,47%,11%)] text-xs font-extrabold tracking-wider shadow-md">
              CHURCHFYONE
            </div>
        ...
        <p className="text-center mt-12 text-xl md:text-2xl font-extrabold text-[hsl(40,33%,98%)]">
